...
const EditEmployee = () => {
    ...
    const fetchEmployeeDetails = async () => {
        try {
            ...
            const response = await axios.get(`https://employee-management-system-g7s7.onrender.com/api/employees/${id}`);
    ...
    const fetchEmployeeDocuments = async () => {
        try {
            ...
            const response = await axios.get(`https://employee-management-system-g7s7.onrender.com/api/employees/${id}/documents`);
    ...
    const handleDownloadDocument = async (doc) => {
        try {
            const response = await axios.get(
                `https://employee-management-system-g7s7.onrender.com/api/employees/${formData.employee_id}/documents/${doc.type}`,
                {
                    responseType: 'blob',
                    headers: { 'Accept': '*/*' }
                }
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://employee-management-system-g7s7.onrender.com/api/employees/${id}`, formData);

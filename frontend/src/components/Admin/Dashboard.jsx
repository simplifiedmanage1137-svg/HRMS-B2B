...
const AdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const employeesRes = await axios.get('https://employee-management-system-g7s7.onrender.com/api/employees');
      ...
      const balancesPromises = employees.map(async (emp) => {
        try {
          const balanceRes = await axios.get(`https://employee-management-system-g7s7.onrender.com/api/leaves/balance/${emp.employee_id}`);
          return {
            ...emp,
  ...
  const refreshAttendanceData = async () => {
    try {
      ...
      const attendanceRes = await axios.get(`https://employee-management-system-g7s7.onrender.com/api/attendance/report?start=${today}&end=${today}`);
  ...
  const refreshLeaveRequests = async () => {
    try {
      const leavesRes = await axios.get('https://employee-management-system-g7s7.onrender.com/api/leaves');

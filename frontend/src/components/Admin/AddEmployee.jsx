...
const generateEmployeeId = async () => {
  ...
  const uploadDocuments = async (empId) => {
    ...
    for (let i = 0; i < validUploads.length; i++) {
      ...
      try {
        ...
        const url = `https://employee-management-system-g7s7.onrender.com/api/employees/${empId}/documents`;
  ...
  const testApiConnection = async () => {
    try {
      const response = await axios.get('https://employee-management-system-g7s7.onrender.com/api/test');
...
const handleFinalSubmit = async (e) => {
  ...
  try {
    ...
    // Create employee
    const response = await axios.post('https://employee-management-system-g7s7.onrender.com/api/employees', employeeData, {
      headers: {

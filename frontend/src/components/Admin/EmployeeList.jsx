...
const EmployeeList = () => {
  ...
  const fetchEmployeeDocuments = async (employee) => {
    try {
      ...
      const response = await axios.get(`https://employee-management-system-g7s7.onrender.com/api/employees/${employee.employee_id}/documents`);
  ...
  const handleViewDocument = async (doc) => {
    try {
      ...
      const viewUrl = `https://employee-management-system-g7s7.onrender.com/api/employees/${selectedEmployeeForDocs.employee_id}/documents/${doc.type}?inline=true`;
  ...
  const handleDownloadDocument = async (doc) => {
    try {
      ...
      const response = await axios.get(
        `https://employee-management-system-g7s7.onrender.com/api/employees/${selectedEmployeeForDocs.employee_id}/documents/${doc.type}`,
        {
          responseType: 'blob',
          headers: {
            'Accept': '*/*'
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      await axios.delete(`https://employee-management-system-g7s7.onrender.com/api/employees/${selectedEmployee.id}`);
